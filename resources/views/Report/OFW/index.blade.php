...
<td>
     <a style="margin-left: 889px;" href="{{route ('list.OFW.save') }}" class="btn btn-primary btn-sm" id="print-button" >Lists of OFW</a>
 </td>
  <!-- Add image tag here -->
  <img class="img-profile rounded-circle" src="{{ asset('auth/img/admin1.png') }}" style="width: 84px; margin-right: 550px; margin-top: -302px; margin-left: 157px;">
         ...
         <section class="content">
                <div class="col-md-12">
                  <p style="margin-top: -40px;">Overseas Filipino Workers </p>
